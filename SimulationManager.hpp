...
struct SimulationSettings {
    unsigned int number_of_mining_trucks = 100;
...
public:
    ...
    // TODO: would it every be possible for settings to be updated during a
    // simulation?
    void SetSimulationSettings(SimulationSettings simulation_settings) {
        ...
        mining_unloading_stations_.resize(
            simulation_settings_.number_of_mining_unload_stations);
    }
...
private:
    ...
    void LoadTruckIntoUnloadingStation(unsigned current_time,
    ...
    static const unsigned kAllocatedSimulationTime =
        72 * timing::kSecondsPerHour;  // Will this ever be configurable in future
                                       // iterations?
};